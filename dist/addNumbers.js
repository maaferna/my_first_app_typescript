    ...
    return new Promise(function (resolve) {
        rl.question(promptText, function (input) {
            ...
            if (isNaN(parsedNumber)) {
                ...
                resolve(promptForNumber(promptText)); // Recursively prompt until a valid number is entered
            }
            else {
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, promptForNumber("Enter the first number: ")];
                case 1:
                    firstNumber = _a.sent();
                    return [4 /*yield*/, promptForNumber("Enter the second number: ")];
                case 2:
